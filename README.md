...
# cs103-S2018-practical1-starter

Designed for use with [GitHub Classroom](https://classroom.github.com/), this
repository contains the starter for Practical 1 in Computer Science 103. Since
...
headers and subheaders and an image. Then, you will use a Markdown conversion
tool, called [Pandoc](https://pandoc.org/) to convert your Markdown to HTML and
then run a web server to provide local access to the static web site. Finally,
you will note the differences in the display of the Markdown on GitHub and the
web site created by your local server.
...
repository. More details about the GatorGrader checks are included later in this
...
textbook, again paying close attention to Figures 1.6 and 1.7, and Section 1.5.
...
- The `answers.md` file has at least two subsections created with a `##`
  marker.
...
you can go to the [Computer Science 103 Practical 1
Starter](https://github.com/Allegheny-Computer-Science-103-S2018/cs103-S2018-practical1-starter)
